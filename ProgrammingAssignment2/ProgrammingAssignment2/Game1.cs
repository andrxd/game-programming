...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            poke0 = Content.Load<Texture2D>(@"graphics\382");
            poke1 = Content.Load<Texture2D>(@"graphics\383");
            poke2 = Content.Load<Texture2D>(@"graphics\384");
